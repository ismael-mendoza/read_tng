...
sim_dir = "/oak/stanford/orgs/kipac/users/phil1/simulations/TNG50_3"
match_file = path.join(sim_dir, "matches/subhalo_matching_to_dark.hdf5")
dir_dmo = path.join(sim_dir + "_Dark", "trees/sublink")
dir_bar = path.join(sim_dir, "trees/sublink")
